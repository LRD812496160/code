		...
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody>
				...
				<tr>
						...
						<input type="password" value="${USER.password }" class="required" name="password" id="password"
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="password"
							value="${USER.password }" class="required" name="repwd" id="repwd" maxlength="10"
				...
				<tr>
					...
					<span class="pn-frequired">*</span>
						...
						<input type="text" value="${USER.realname }" class="required" name="realname" id="realname" maxlength="10" onblur="chkrealname()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" value="${USER.birthdayTxt }" name="birthday" maxlength="80"   class="Wdate" onclick="WdatePicker()" readonly="readonly"/>
					</td>
				</tr>
				...
				<tr>
					...
					<span class="pn-frequired">*</span>
						...
						<input type="text" value="${USER.email }" class="required" name="email" id="email" maxlength="10" onblur="chkemail()"/>
